module OldAWS
  module S3
    ...
    #   pp policy.grants
    #   [#<OldAWS::S3::ACL::Grant FULL_CONTROL to noradio>,
    #    #<OldAWS::S3::ACL::Grant READ to AllUsers Group>]
    # 
    ...
    # 
    #   grant = ACL::Grant.new
    #   # => #<OldAWS::S3::ACL::Grant (permission) to (grantee)>
    ...
    #   # => #<OldAWS::S3::ACL::Grantee (xsi not set yet)>
    # 
    ...
    #   grant
    #   # => #<OldAWS::S3::ACL::Grant READ_ACP to AllUsers Group>
    # 
    ...
    module ACL
      ...
      #   grant
      #   => #<OldAWS::S3::ACL::Grant READ to (grantee)>
      #
