module OldAWS
  module S3
    ...
    # 
    #   Service.buckets
    #   # => [#<OldAWS::S3::Bucket @attributes={"name"=>"jukebox"}>]
    # 
    ...
    #   # => [#<OldAWS::S3::S3Object '/jukebox/black-flowers.mp3'>]
    # 
    ...
    class Bucket < Base
      class << self
        ...
        #     # => [<OldAWS::S3::S3Object '/jazz/miles.mp3'>, <OldAWS::S3::S3Object '/jazz/dolphy.mp3'>, <OldAWS::S3::S3Object '/classical/malher.mp3'>]
        #     Bucket.objects('jukebox', :prefix => 'classical')
        #     # => [<OldAWS::S3::S3Object '/classical/malher.mp3'>]
        #
        ...
        #     # => [<OldAWS::S3::S3Object '/jazz/miles.mp3'>]
        #
        # === Examples
        #
        ...
        #   # => [<OldAWS::S3::S3Object '/jazz/miles.mp3'>, <OldAWS::S3::S3Object '/classical/malher.mp3'>]
        #
        ...
        # List all your buckets. This is a convenient wrapper around OldAWS::S3::Service.buckets.
      ...
      #
      #   bucket.objects
      #   => [#<OldAWS::S3::S3Object '/marcel_molina/beluga_baby.jpg'>,
      #       #<OldAWS::S3::S3Object '/marcel_molina/tongue_overload.jpg'>]
